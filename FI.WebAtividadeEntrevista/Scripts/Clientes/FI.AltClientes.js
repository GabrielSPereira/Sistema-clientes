...
$(document).ready(function () {
    if (obj) {
        ...
        $('#formCadastro #CEP').val(geraCEPFormatado(obj.CEP));
        ...
        $('#formCadastro #CPF').val(geraCPFFormatado(obj.CPF));


        $.ajax({
            url: '/Beneficiario/ListaPorCliente',
            method: 'GET',
            ...
            success: function (response) {
                response.Records.forEach(function (beneficiario) {
                    ...
                    SetaBeneficiarioLocalStorage(nome, cpf, id);
                });
